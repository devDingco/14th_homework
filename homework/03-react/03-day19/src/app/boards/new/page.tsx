...
export default function BoardsNew() {
  ...
  const onChangeUserName = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    setIsActive(event.target.value && password && title && content ? true : false);
  };
  const onChangePassword = (event: ChangeEvent<HTMLInputElement>) => {
    setPassword(event.target.value);
    setIsActive(username && event.target.value && title && content ? true : false);
  };
  const onChangeTitle = (event: ChangeEvent<HTMLInputElement>) => {
    setTitle(event.target.value);
    setIsActive(username && password && event.target.value && content ? true : false);
  };
  const onChangeContent = (event: ChangeEvent<HTMLTextAreaElement>) => {
    setContent(event.target.value);
    setIsActive(username && password && title && event.target.value ? true : false);
  };
