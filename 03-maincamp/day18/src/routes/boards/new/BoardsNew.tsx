...
import 사진업로드 from '../../../assets/images/사진업로드.png'
import 별표 from '../../../assets/images/별표.png'
  ...
  return (
      ...
      <main>
          ...
          <section className="메인__등록하기섹션">
              ...
              <button className={isActive === true ? "메인__등록하기섹션__등록하기버튼__액티브" : "메인__등록하기섹션__등록하기버튼__낫액티브"} onClick={validation}>등록하기</button>
          </section>
