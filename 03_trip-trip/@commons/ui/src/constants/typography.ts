 ...
 * Figma Node ID: 11001:35020
 */

// 폰트 패밀리 정의
export const fontFamilies = {
  korean: 'var(--font-pretendard), Pretendard, -apple-system, BlinkMacSystemFont, sans-serif',
  english: 'var(--font-pretendard), Pretendard, -apple-system, BlinkMacSystemFont, sans-serif',
  mono: 'monospace',
} as const;
...
// 영문/숫자용 타이포그래피 (영문 폰트는 추후 변경 가능하도록 분리)
