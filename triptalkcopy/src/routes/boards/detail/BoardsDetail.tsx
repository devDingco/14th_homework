...
import Good from "../../../assets/icon/outline/redgood.svg";
    ...
    <div className="page">
      <div className="detail-container">
        ...
        <div className="detail-author">
          <div className="detail-author__author">
            <img src={ProfileIcon} />
            양지윤
          </div>
          <div className="detail-author__date">2025.08.27 </div>
        </div>
        <hr className="line" />
        <div className="detail-link-location">
          <div className="detail-link-location__enroll">
            <img src={LinkIcon} />
        ...
        <div className="detail-heart">
          <div className="detail-heart__bad">
            <img src={Bad} />
            24
          </div>
          <div className="detail-heart__good">
            <img src={Good} />
            12
          </div>
        </div>
        <div className="detail-button-group">
          <button className="deatil-button-list">
            <img src={Menu} />
            목록으로
          </button>
          <button className="deatil-button-edit">
            <img src={Edit} />
            수정하기
          </button>
        </div>
