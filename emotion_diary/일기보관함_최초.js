...
const 일기그리기기능 = () => {
    ...
    let 새로운일기도화지 = "";                          //=>이건 무엇인가...왜 이렇게 지정하는가....

    for (let index = 0; index < 일기목록.length; index++) {
        const el = 일기목록[index];
        새로운일기도화지 += `
        <a href="../일기상세/일기상세_메인.html?number=${index}"></a>                 // =>링크걸기
            <div class=.메인_바디_일기장_일기저장_A>
                <div class=메인_바디_일기장_일기저장_사진>
                        ${el.기분 === "행복"
                    ? '<img class="메인_바디_일기장_일기저장_사진" src="../images/482545f2394c18eb9129e4d3f22f03a59519cfdc.png" alt="행복해요">'
                    : ""
                    }
                        ${el.기분 === "슬픔"
                    ? '<img class="메인_바디_일기장_일기저장_사진" src="../images/8aed48b7b19da762c846d560f8bfcde81d4efdc5.png" alt="행복해요">'
                    : ""
                    }
                        ${el.기분 === "놀람"
                    ? '<img class="메인_바디_일기장_일기저장_사진" src="../images/cf614b98a0d14d42505d44a355217f4a6333160a.png" alt="행복해요">'
                    : ""
                    }
                        ${el.기분 === "화남"
                    ? '<img class="메인_바디_일기장_일기저장_사진" src="../images/7ea3786b4ae621ed2ead07f5b36fb83001247dba.png" alt="행복해요">'
                    : ""
                    }
                        ${el.기분 === "기타"
                    ? '<img class="메인_바디_일기장_일기저장_사진" src="../images/88d3f65047d90f65f868897bceebf4a1969de84b.png" alt="행복해요">'
                    : ""
                    }
                </div>
                <div class= "메인_바디_일기장_일기저장_내용_감정과날짜">
                    ...
                    ${el.기분 === "기타"
                    ? `<div class="메인_바디_일기장_일기저장_내용_감정_행복해요">기타</div>`
                    : ""
                    } 
    ...
    window.document.getElementById("메인_바디_일기장_일기저장_").innerHTML =
        새로운일기도화지;
...
const 글쓰기기능 = () => {
   ...
   // 0.글쓰는 날 날짜 추가 
    ...
    const 제목담는박스 = document.getElementsById("제목입력창").value;
    const 내용담는박스 = document.getElementsById("내용입력창").value;
    const 날짜담는박스 = 날짜자동추가.year + ". " + 날짜자동추가.month + ". " + 날짜자동추가.date;
    
    let 기분담는박스;
    const 기분선택버튼목록 = document.getElementsById("기분상태체크");
