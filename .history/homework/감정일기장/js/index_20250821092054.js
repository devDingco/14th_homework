...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // ✨ 완료 모달 관련 요소들 추가
  const 모달배경2 = document.getElementById('모달배경2'); // 완료 모달 배경
  const 확인버튼 = document.getElementById('확인버튼'); // 완료 모달 확인 버튼
  ...
  // ✨ 완료 모달 이벤트들 추가
  모달배경2.addEventListener('click', function () {
    모달닫기('등록완료모달'); // 완료 모달 닫기
    모달닫기('모달등록'); // 일기쓰기 모달도 함께 닫기
  });

  확인버튼.addEventListener('click', function () {
    모달닫기('등록완료모달'); // 완료 모달 닫기
    모달닫기('모달등록'); // 일기쓰기 모달도 함께 닫기
