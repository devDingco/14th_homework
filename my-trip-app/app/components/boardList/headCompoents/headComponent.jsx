    ...
    <div className="head_component_container">
      <div className="searchbar-with-calender-container">
        <div className="searchbar-container">
          <Image src="/icons/outline/search.png" alt="search" width={24} height={24} />
          <input className="r_16_24" type="text" placeholder="검색어를 입력해주세요." />
        </div>
        <div className="calender-container">
          <Image src="/icons/outline/calendar.png" alt="calendar" width={24} height={24} />
          ...
          <button type="button" className="post-button sb_18_24">
            <Image src="/icons/outline/write.png" alt="plus" width={24} height={24} />
            트립토크 등록
          </button>
    </div>
  );
