...
type ModalType = 'success' | 'purchase' | 'fail' | 'passwordChange';

interface ModalProps {
  isOpen: boolean;
  onClose: () => void;
  type: ModalType | null;
  handleOpenFailModal?: () => void;
}

export default function Modal({ isOpen, onClose, type, handleOpenFailModal }: ModalProps) {
