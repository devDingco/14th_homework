...
export default function BookingDetail() {
  ...
  const booking = bookingMock.find((item) => item.id === Number(id));
      ...
      <div className="booking_detail_header_wrapper">
        <div className="booking_detail_title_wrapper">
          ...
          <div className="booking_detail_button_wrapper">
            <span>
              <Image src="/icons/booking/delete.png" width={24} height={24} />
            </span>
            <span>
              <Image src="/icons/booking/link.png" width={24} height={24} />
            </span>
            <span>
              <Image src="/icons/booking/location.png" width={24} height={24} />
            </span>
            <span className="booking_float_wrapper">
              <Image src="/icons/booking/bookmark.png" width={18} height={18} />
        ...
        <div className="booking_detail_purchase_wrapper">
          ...
          <div className="booking_detail_seller_wrapper">
            ...
            <div className="booking_detail_seller_info">
              <Image src={'/images/profile/profile09.png'} width={40} height={40} />
