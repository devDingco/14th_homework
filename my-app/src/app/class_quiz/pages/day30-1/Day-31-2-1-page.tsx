...
const Day30_1 = () => {
  ...
  }, [inView, hasMore, fetchBoards, page]);
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4">게시글 목록 (라이브러리 사용)</h1>

      <div className="h-[500px] overflow-y-auto border border-gray-300 rounded-lg p-4">
