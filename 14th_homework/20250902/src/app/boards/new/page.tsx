  ...
  const handleSubmit = async () => {
    ...
    const createBoardInput = {
      ...
      boardAddress: {
        ...
        streetAddress: boardAddress.streetAddress || "",
        detailAddress: boardAddress.detailAddress || ""
      },
      ...
      <div className="form-group">
        ...
        <div className="flex-gap-8 mb-8">
          <input 
            ...
            onChange={(e) => setBoardAddress({ ...boardAddress, zipcode: e.target.value })}
          />
        ...
        <input 
          ...
          onChange={(e) => setBoardAddress({ ...boardAddress, streetAddress: e.target.value })}
        />
        <input 
          type="text" 
          className="input-field" 
          ...
          onChange={(e) => setBoardAddress({ ...boardAddress, detailAddress: e.target.value })}
        />
      </div>
