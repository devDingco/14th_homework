...
export type FetchBoardDetailQuery = { __typename?: 'Query', fetchBoard: { __typename?: 'Board', _id: string, writer?: string | null, title: string, contents: string, likeCount: number, dislikeCount: number, createdAt: any, updatedAt: any } };
