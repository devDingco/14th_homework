    ...
    <div className="max-w-3xl mx-auto p-6">
      ...
      <div className="flex justify-between items-center border-t pt-4">
        ...
        <div className="flex space-x-4">
          <button className="flex items-center border px-3 py-1 rounded" onClick={onClickMoveToList}>
            <Image
              src="/images/list.png"
              alt="목록"
              width={20}
          ...
          <button className="flex items-center border px-3 py-1 rounded" onClick={onClickMoveToEdit}>
            <Image
