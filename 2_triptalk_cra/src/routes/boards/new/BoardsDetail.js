                    ...
                    <div className='boards_body'>
                        <div className='boards_body_main'>
                            ...
                            <div className='글쓴이_날짜'>
                                <div className='글쓴이_날짜_좁은거'>
                                    <div className='글쓴이 글쓴이_font'>
                                        ...
                                        <div className="글쓴이_name">
                                            홍길동
                                        </div>
                                    </div>
                                    <div className='날짜 날짜_font'>
                                        2024.11.11
                                    </div>
                                </div>
                            ...
                            <div className='buttons'>
                                <button className='button button_font'><img src='/list.png'></img>목록으로</button>
                                <button className='button button_font'><img src='/fix.png'></img>수정하기</button>
                            </div>
                        </div>
                    </div>
                </div>
