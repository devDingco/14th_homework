...
function applyTheme(isDark) {
  ...
  const floatingButton = document.querySelector(".floating-button-icon");
  ...
  if (isDark) {
    ...
    if (floatingButton) {
      floatingButton.src = "./public/icons/dark/up_outline_dark_xl.svg";
    }
    ...
    if (floatingButton) {
      floatingButton.src = "./public/icons/light/up_outline_light_xl.svg";
    }
